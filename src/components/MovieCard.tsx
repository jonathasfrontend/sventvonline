        ...
        <div className="w-full h-screen bg-gray-800 relative overflow-hidden">
            ...
            <div className=" absolute w-full h-[400px] flex justify-between bottom-0 px-16 py-5 z-20">
                <div className="max-w-[700px]">
                    <h3 className="text-[50px] font-bold">{props.title}</h3>
                    <span className="text-sm">Duração: {formatDuration(props.runTime)}</span>
                <p className="text-base max-w-[500px] font-semibold text-gray-300 my-5">{props.description.short}</p>
                </div>
